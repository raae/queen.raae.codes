...
When working with the newly released [Framer](https://framer.link/queen-raae) Forms I needed a quick way to check exactly what was sent to the webhook and remembered a tool I've used before: [Webhook.site](https://webhook.site/).
